    ...
    for entry in json:
        ...
        try:
            ...
            if entry=='tizonaclient@0.3.0':
                print(entryData)
                license='MIT'
            licenseFiles.append('{'+f'"dependency": "{entry}","license": "{license}","licenseFile": "{licenseFile}","repository":"{repository}"'+"}")
        except:
...
def writeLicenses(licenseFiles):
    ...
    for entry in licenseFiles:
        ...
        jsonData={"dependency":dependency,"repository":repository,"license":license,"licenseContent":licenseContent}
